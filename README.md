...
4. Assignment of TCRA and TCRB CDR3 to single-nuclei - user defined. Example of an approach in the Slide-GoTags manuscript is in this [python script](https://github.com/amitsud/Slide-GoTags/blob/main/assign_tcr_cdr3.R)
